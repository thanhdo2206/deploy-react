...
import { archiveSectionApi, unArchiveSectionApi, updateTitleSectionApi } from '../../../redux/actions/SectionAction';
...
export default function ProjectSectionForm(props) {
	...
	const [isShowModalUnarchiveSection, setShowModalUnarchiveSection] = useState(false);
	...
	const handleModalUnArchiveSection = type => {
		if (type === MODAL_ACTION_CONFIRM) {
			dispatch(unArchiveSectionApi(sectionId))
		}
